...
namespace TravelReviewProject.Controllers
{
    public class DestinationsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,City,Country,Language")] Destination destination)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,City,Country,Language")] Destination destination)
        {
            if (ModelState.IsValid)
            {
